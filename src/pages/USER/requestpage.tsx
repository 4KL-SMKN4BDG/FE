      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        {/* BACK */}
          ...
          <div className="h-80 rounded-2xl border bg-white flex items-center justify-center shadow"
                style={{
              backgroundImage: `url("${oneCompany?.logo}")`,
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            {role === "STUDENT" && (<button className="px-12 py-3 bg-blue-600 text-white rounded-full shadow-md hover:bg-blue-700 transition duration-300 w-fit"
                onClick={ () => {
