...
const handleSubmit = (e: React.FormEvent) => {
    ...
    <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {/* BACK */}
        <button onClick={() => navigate(listed.GuruPage)} className="mb-6 flex items-center gap-2 text-sm font-bold text-gray-500 hover:underline">
        ...
        <div className="md:col-span-2 flex flex-col gap-5">
            ...
            <select value={perusahaan} onChange={(e) => setPerusahaan(e.target.value)} className="select select-bordered w-full" required>
